...
@Test
 ...
 //Before filling name Screenshot
   
   TakesScreenshot ts=(TakesScreenshot)driver;
   File src=ts.getScreenshotAs(OutputType.FILE);
   File trg=new File("D:\\AutomationLearning eclispe\\Selenium\\src\\main\\java\\ScreenShotPacjage\\screenshotname1.png");
   ...
   //Before selecting DOB Screenshot
   
    TakesScreenshot ts1=(TakesScreenshot)driver;
    File src1=ts1.getScreenshotAs(OutputType.FILE);
    File trg1=new File("D:\\AutomationLearning eclispe\\Selenium\\src\\main\\java\\ScreenShotPacjage\\screenshotname.png");
    
    try {
		FileUtils.copyFile(src1, trg1);
		System.out.println("Screenshot saved to: " + trg1);
	} catch (IOException e) {
		System.out.println("Failed to save screenshot: " + e.getMessage());
 ...
 //Before selecting DOB Screenshot
   ...
   File trg2=new File("D:\\AutomationLearning eclispe\\Selenium\\src\\main\\java\\ScreenShotPacjage\\screenshotafterDOB.png");
   
   try {
		FileUtils.copyFile(src2, trg2);
		System.out.println("Screenshot saved to: " + trg2);
	} catch (IOException e) {
		System.out.println("Failed to save screenshot: " + e.getMessage());
